...
public class AsyncDataLoaderRefresh extends AsyncTask<String,Void,String>{
    private MainActivity mainActivity;
    CompanyStock companyStock =new CompanyStock();
    private int count;
    private static String AllStocks = "https://api.iextrading.com/1.0/stock/";

    public AsyncDataLoaderRefresh(MainActivity ma, CompanyStock companyStock)
    {
        mainActivity = ma;
    ...
    protected void onPostExecute(String sb)
    {
        ...
        else
        {
            ...
            System.out.print("String Builder data after cleaning:"+clean);
            TempStocks tempStocks = parseJSON(clean);
            mainActivity.SelectSymbolTemp2(tempStocks);
        }
    }
